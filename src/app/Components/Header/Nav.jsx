...
export default function Nav({ setMobileToggle }) {
  return (
    <ul className="cs_nav_list fw-medium">
      ...
      <li className="menu-item-has-children">
        ...
        <DropDown>
          <ul>
            ...
            <li>
              <Link
                href="/project/project-details-right"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/project/project-details-center"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/projectdark/project-details-dark"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/projectdark/project-details-right-dark"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/projectdark/project-details-center-dark"
                onClick={() => setMobileToggle(false)}
              >
      ...
      <li className="menu-item-has-children">
        ...
        {/* <DropDown>
          <ul>
            ...
            <li>
              <Link
                href="/service/service-details-right"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/service/service-details-center"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/servicedark/service-details-dark"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/servicedark/service-details-right-dark"
                onClick={() => setMobileToggle(false)}
              >
            ...
            <li>
              <Link
                href="/servicedark/service-details-center-dark"
                onClick={() => setMobileToggle(false)}
              >
      ...
      <li className="menu-item-has-children">
        <Link href="/career" onClick={() => setMobileToggle(false)}>
          Careers
        </Link>
      </li>
      <li className="menu-item-has-children">
        <Link href="/industries" onClick={() => setMobileToggle(false)}>
          Industries
        </Link>
      </li>
    </ul>
