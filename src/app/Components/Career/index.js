                ...
                <div className="details-post-area">
                  ...
                  <div className="heading1">
                    ...
                    <p>
                      ...
                      continuous learning. We are a rapidly growing company. To
                      support our expansion plans and achieve our growth
                    ...
                    <p>
                      ...
                      candidates. We work hard to get to know and understand our
                      clients and our IT consultants to ensure the best fit
                      possible.
                    </p>
                    <div className="space16"></div>
                    <p>
                    ...
                    <div className="space16"></div>
                    <p>
                      Our team of dedicated account managers and recruiters work
                      closely together to translate the client’s technical
                      requirement in to a complete business requirement.
                      Recruiters are then able to arrange for the best fit
                      technically while keeping a close eye on the business fit
                      as well. The team also works closely with each candidate
                      to draw their career path to make sure that they grow
                      mutually with the company. The team invests time to
                      understand the candidate’s key strengths and weaknesses,
                      their needs and career goals and their personal
                      preferences.
                    </p>
                    <div className="space16"></div>
